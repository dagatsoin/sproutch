...
export type ThemeConfig<B, O extends Record<string, object> = Record<string, object>> = Partial<{
  shape: Shape
...
export type Theme<B, O extends Record<string, object> = Record<string, object>> = {
  shape: Shape
  palette: Palette
  spacing: number
  business: Status & B
...
export function override<C extends object, K extends keyof C, S extends keyof NonNullable<C[K]>>(
  overrides: C,
  compName: K,
  slot: S
