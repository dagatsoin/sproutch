...
const defaultPalette: Palette = {
  ...
  type: 'light',
  primary: {
    light: colors.indigo[ '300' ], // #7986cb
    main: colors.indigo[ '500' ], // #3f51b5
    dark: colors.indigo[ '700' ], // #303f9f
    contrastText: colors.white, // #ffffff
  },
  secondary: {
    light: colors.pink[ 'A200' ], // #ff4081
    main: colors.pink[ 'A400' ], // #f50057
    dark: colors.pink[ 'A700' ], // #c51162
    contrastText: colors.pink[ '' ], // #ffffff
  },
  grey: colors.grey,
  text: {
...
export const defaultTheme: Theme<Status, {}> = getTheme({
  business: {
    error: {
...
export function override(overrides: any, compName: string, rule: string) {
  return overrides[ compName ] && overrides[ compName ][ rule ]
